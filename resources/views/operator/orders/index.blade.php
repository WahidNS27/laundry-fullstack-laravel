...
@section('content')
    <div class="mb-6 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <div class="flex items-center gap-3 w-full md:w-auto">
            <form action="{{ route('operator.orders.index') }}" method="GET" class="relative w-full md:w-64">
            ...
            <a href="{{ route('operator.orders.create') }}"
                class="bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors shadow-sm whitespace-nowrap pt-2.5 pb-2.5">
                <i class="fas fa-cart-plus mr-2"></i> Buat Baru
            </a>
        </div>
    </div>
